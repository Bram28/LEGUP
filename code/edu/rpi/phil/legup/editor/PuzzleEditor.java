...
public class PuzzleEditor extends JFrame implements ActionListener
{
	...
	EditorBoardFrame initialBoard = null;
	...
	{
		new PuzzleEditor().setVisible(true);
	}
				...
				if (pgd.okPressed)
				{
					...
					if (!error)
					{
						...
						if (d != null) // they didn't cancel
						{
							...
							initialBoard = new EditorBoardFrame(i, pm,this);
				...
				if (filename != null) // user didn't pressed cancel
				{
					...
					if (s != null)
					{
						...
						if (!error)
						{
							...
							initialBoard = new EditorBoardFrame(s, pm,this);
							initialBoard.setVisible(true);
						}
						else
							JOptionPane.showMessageDialog(null,"Error loading puzzle module " + puzzleModuleName);
