 ...
 *
 */
public class FillapixEditorBoardFrame extends JFrame implements WindowListener
{
	...
	FillapixPuzzleEditor parent = null;
	 ...
	 */
	public FillapixEditorBoardFrame(BoardState state, PuzzleModule pm, FillapixPuzzleEditor parent)
	{
		this.parent = parent;
		curState = state;
		this.pm = pm;
