...
//		 legupMain.getAvailableBoardsList(puzzle)
	...
	public void initPuzzles(Legup legupMain)
	{
		Object[] o = legupMain.getConfig().getPuzzleList().toArray();
		...
		{
			o = legupMain.getConfig().getBoardsForPuzzle(games[x]).toArray();
